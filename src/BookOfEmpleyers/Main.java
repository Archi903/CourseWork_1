...
public class Main {
    ...
    public static void CourseWork1() {
        ...
        employee[0] = new Employee(" Иванов Иван Иванович", 1, 20000);
        ...
        int minSum = employee[0].getSalary();
        ...
        int maxSum = employee[0].getSalary();
        for (Employee value : employee) {
        ...
        double averageMonth = (sumMonth * 1.) / employee.length;
